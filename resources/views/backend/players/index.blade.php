            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header clearfix">
                    <div class="pull-left">
                        <a href="{{ route('backend.players.create') }}" class="btn btn-success"><i class="fa fa-plus"></i> Add New</a>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body ">
                ...
                <div class="box-footer clearfix">
                    ...
                    <div class="pull-right">
                        <small>{{ $playerCount }} {{ str_plural('Item', $playerCount) }}</small>
                    </div>
                </div>
              </div>
              <!-- /.box -->
