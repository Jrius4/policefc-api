                                ...
                                <div class="article-slider">
                                    <div id="carusel-11-30" class="uk-slidenav-position" data-uk-slideshow="{ height : 510 }">
                                        <ul class="uk-slideshow">
                                            <li>
                                                <div style={{backgroundImage:`url(${news})`}} class="uk-cover-background uk-position-cover"></div>
                                                <img style="width: 100%; height: auto; opacity: 0;" src={news} alt=""/>
                                            </li>
                                            <li>
                                                <div style={{backgroundImage:`url(${news1})`}} class="uk-cover-background uk-position-cover"></div>
                                                <img style="width: 100%; height: auto; opacity: 0;" src={news1} alt=""/>
                                            </li>
                                        </ul>
                                ...
                                <div class="info">
                                    ...
                                    <div class="name">
                                        <h4>
                                            ...
                                            Suspendisse purus enim, dictum sed lorem ac, sodales maximus est</Link>        
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="latest-news-wrap">
                                ...
                                <div class="info">
                                    ...
                                    <div class="name">
                                        <h4>
                                            <Link to="/news-single">
                                            Cum sociis natoque penatibus et magnis dis parturient</Link>       
                                        </h4>
                                    </div>
                                </div>
                            </div>
