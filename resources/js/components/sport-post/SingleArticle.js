...
import OneAside from '../asides/OneAside';
import Linkify from 'react-linkify'
import ExternalLinks from '../../common/ExternalLinks';
import ArticleCommentFeed from './ArticleCommentFeed';
      ...
      postContent =(
        ...
        {post.map(
            (data,index)=>(
              <div key={index}>
                ...
                />
                <ArticleCommentForm postId={data.id}/>
              </div>
            )
          )
        }
        ...
        <div className="uk-container uk-container-center">
          <div id="tm-middle" className="tm-middle uk-grid" data-uk-grid-match="" data-uk-grid-margin="">
            ...
            <OneAside posts={this.props.post.posts} categories={this.props.post.categories}/>
            <hr/>
            <div>
